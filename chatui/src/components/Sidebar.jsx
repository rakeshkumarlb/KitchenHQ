import { Activity, BookOpen, ChefHat, ClipboardCheck, LayoutDashboard, MessageCircle, Package, PanelLeftClose, PanelLeftOpen, Soup, UserRound, Workflow } from 'lucide-react';
