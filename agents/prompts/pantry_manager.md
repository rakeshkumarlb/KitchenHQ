...
- When you save a shopping list, notify the household with send_shopping_list_email — pass the shopping items themselves (the ones you just added to add_shopping_items) along with your reasoning; the tool renders and sends, it does not read the list.
